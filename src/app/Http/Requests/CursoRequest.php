...
class CursoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'ato_autorizacao' => ['nullable', 'file', 'mimes:pdf', 'max:61440'],
            'horario' => ['nullable', 'file', 'mimes:pdf', 'max:61440'],
            'calendario' => ['nullable', 'file', 'mimes:pdf', 'max:61440'],
